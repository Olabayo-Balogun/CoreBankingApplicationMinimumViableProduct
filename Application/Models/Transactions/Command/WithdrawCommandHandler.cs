...
namespace Application.Models.Transactions.Command
{
    public class WithdrawCommandHandler : IRequestHandler<WithdrawCommand, RequestResponse<TransactionResponse>>
    {
        ...
        public WithdrawCommandHandler (IOptions<AppSettings> appsettings, IMapper mapper, ITransactionRepository transactionRepository, IAccountRepository accountRepository, IUserRepository userRepository, IIndustryFieldRepository industryFieldRepository)
        {
            _mapper = mapper;
